        ...
        <div className='px-4'>
            ...
            <div>
                <form action="" className='flex flex-col '>
                    ...
                    <input className='w-full bg-white border border-gray-300 h-14 rounded-xl mb-4 outline-none pl-3' type="text" placeholder='enter name' />
                    <label className='text-blue-txt text-sm pb-1' htmlFor="">Country</label>
                    <input className='w-full bg-white border border-gray-300 h-14 rounded-xl mb-8 outline-none pl-3' type="text" placeholder='enter country' />
                    ...
                    <input className='w-full bg-white border border-gray-300 h-14 rounded-xl mb-4 outline-none pl-3' type="password" placeholder='enter password again' />
