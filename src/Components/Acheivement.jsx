    ...
    <div className='bg-white mt-20 w-full h-362 gap-6 flex flex-col items-center pt-8'>
        ...
        <div className='flex gap-4 items-center'>
            <div className='flex flex-col items-center'>
                <p className='font-semibold text-32 text-sinarpurple'>3000+</p>
                <p className='font-medium text-sm'>Learners</p>
            </div>
            <img src={sugarCube} alt="" className='w-11 h-11' />
            <div className='flex flex-col items-center'>
                <p className='font-semibold text-32 text-sinarpurple'>100+</p>
        ...
        <div className='flex gap-4 items-center'>
            <div className='flex flex-col items-center'>
                <p className='font-semibold text-32 text-sinarpurple'>25+</p>
                <p className='font-medium text-sm'>Years of service</p>
            </div>
            <img src={sugarCube} alt="" className='w-11 h-11' />
            <div className='flex flex-col items-center'>
                <p className='font-semibold text-32 text-sinarpurple'>150+</p>
