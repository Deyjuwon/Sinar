...
import caliders from '../assets/canliders1.png'

const LivePanel = () => {
  return (
    <div className='relative'>
        <img className='' src={caliders} alt="" />
        <div className='bg-white flex flex-col gap-3 items-center   w-52 h-fit py-4 rounded-xl absolute top-64 right-28 shadow-2xl'>
